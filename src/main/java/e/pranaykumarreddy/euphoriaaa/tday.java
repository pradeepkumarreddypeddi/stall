...
public class tday extends AppCompatActivity {

    Gallery simpleGallery;
    CustomGalleryAdapter customGalleryAdapter;
    ImageView selectedImageView;
    // array of images
    int[] images = {  R.drawable.tdaypic2,R.drawable.tdaypic1, R.drawable.tadaypic3, R.drawable.tdaypic4, R.drawable.tdaypic5, R.drawable.tdaypic6};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tday);
