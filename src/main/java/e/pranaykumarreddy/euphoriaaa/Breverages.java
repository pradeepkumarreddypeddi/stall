...
public class Breverages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breverages);
        databaseUser = FirebaseDatabase.getInstance().getReference("Breverage User");
        ...
        register=findViewById(R.id.registerbreveragesbtn);

        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addUser();
                Intent i =new Intent(Breverages.this,results.class);
                startActivity(i);
            }
        });
    }
