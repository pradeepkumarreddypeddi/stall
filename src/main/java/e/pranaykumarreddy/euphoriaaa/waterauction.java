...
public class waterauction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waterauction);
        databaseUser = FirebaseDatabase.getInstance().getReference("WaterUser");
        ...
        register=findViewById(R.id.registerwaterbtn);

        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addUser();
                Intent i =new Intent(waterauction.this,results.class);
                startActivity(i);
            }
        });
    }
