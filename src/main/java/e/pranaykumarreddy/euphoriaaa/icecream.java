...
public class icecream extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseUser = FirebaseDatabase.getInstance().getReference("IceCream User");
        ...
        register=findViewById(R.id.registericecreambtn);

        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addUser();
                Intent i =new Intent(icecream.this,results.class);
                startActivity(i);
            }
        });
    }
